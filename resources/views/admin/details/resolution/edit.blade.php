            ...
            <div class="page-title">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">
                        <a style="display:inline;" href="{{ route('admin.products.index') }}">Resolutions</a>
                    </li>
                    <li class="breadcrumb-item active">Edit Resolution -->> {{ $resolution->name }}</li>
                </ol>
            </div>
        </div>
    </div>
                ...
                <div style="margin-top: 26px" class="card">
                    ...
                    <div class="card-body">
                        <form id="createUser" novalidate method="POST"
                            action="/dashboard/resolutions/{{ $resolution->id }}">
                            @csrf
                            @method('PUT')
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="name" value="{{ $resolution->name }}" type="text"
