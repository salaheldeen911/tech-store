                                ...
                                <form>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="textarea" class="form-control" name="textarea" rows="4" placeholder="Messages"></textarea>
                                        </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="suport-block">
                                        ...
                                        <div class="support-content">
                                            <h4>Sales Inquiry</h4>
                                            <p>Suspendisse sodales venenatis velitut fringilla lorem on vulputateam augue
                                                nislpretium qutristique sodales serotut fringilla.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
