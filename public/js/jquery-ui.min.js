            ...
            function d(f, g, l, m) {
                c.each(e, function () {
                    ...
                    if (l)
                        g -=
                            parseFloat(
                                c.curCSS(f, "border" + this + "Width", true)
                            ) || 0;
                    if (m)
                        g -=
                            parseFloat(c.curCSS(f, "margin" + this, true)) || 0;
                });
                return g;
            }
...
(function (d) {
    d.widget("ui.draggable", d.ui.mouse, {
        ...
        _getHandle: function (a) {
            var b =
                !this.options.handle ||
                !d(this.options.handle, this.element).length
                    ? true
                    : false;
            ...
            if (a.containment == "document" || a.containment == "window")
                this.containment = [
                    ...
                    d(a.containment == "document" ? document : window).width() -
                        ...
                        this.margins.left,
                    (d(
                        a.containment == "document" ? document : window
        ...
        _generatePosition: function (a) {
            ...
            if (this.originalPosition) {
                ...
                if (b.grid) {
                    g =
                        this.originalPageY +
                        Math.round((g - this.originalPageY) / b.grid[1]) *
                            b.grid[1];
                    g = this.containment
                        ? !(
                    ...
                    e =
                        this.originalPageX +
                        Math.round((e - this.originalPageX) / b.grid[0]) *
                            b.grid[0];
                    e = this.containment
                        ? !(
                ...
                if (!c.axis || c.axis != "x")
                    if (a.pageY - d(document).scrollTop() < c.scrollSensitivity)
                        f = d(document).scrollTop(
                            d(document).scrollTop() - c.scrollSpeed
                        );
                    else if (
                        d(window).height() -
                            (a.pageY - d(document).scrollTop()) <
                        c.scrollSensitivity
                    )
                        f = d(document).scrollTop(
                            d(document).scrollTop() + c.scrollSpeed
...
(function (e) {
        ...
        stop: function (b) {
            ...
            a.element.animate(e.extend(f, h && g ? { top: h, left: g } : {}), {
                ...
                step: function () {
                    ...
                    d &&
                        d.length &&
                        e(d[0]).css({ width: i.width, height: i.height });
                    a._updateCache(i);
    ...
    e.ui.plugin.add("resizable", "grid", {
        resize: function () {
            ...
            var h =
                Math.round((c.width - d.width) / (a.grid[0] || 1)) *
                (a.grid[0] || 1);
            a =
                Math.round((c.height - d.height) / (a.grid[1] || 1)) *
                (a.grid[1] || 1);
            if (/^(se|s|e)$/.test(g)) {
                ...
                e(c.target)
                    ...
                    .each(function () {
                        ...
                        if (b) {
                            var g =
                                !c.metaKey ||
                                !b.$element.hasClass("ui-selected");
                            b.$element
                                .removeClass(
                                    g ? "ui-unselecting" : "ui-selected"
                                )
                                .addClass(
                                    g ? "ui-selecting" : "ui-unselecting"
                                );
                            b.unselecting = !g;
                            b.selecting = g;
                            (b.selected = g)
...
(function (d) {
    d.widget("ui.sortable", d.ui.mouse, {
            ...
            if (this.options.scroll) {
                ...
                if (
                    ...
                    if (
                        ...
                        a.pageY - this.overflowOffset.top <
                        b.scrollSensitivity
                    )
                        this.scrollParent[0].scrollTop = c =
                            this.scrollParent[0].scrollTop - b.scrollSpeed;
                    if (
                        ...
                        a.pageX - this.overflowOffset.left <
                        b.scrollSensitivity
                    )
                        this.scrollParent[0].scrollLeft = c =
                            this.scrollParent[0].scrollLeft - b.scrollSpeed;
                    ...
                    if (a.pageY - d(document).scrollTop() < b.scrollSensitivity)
                        c = d(document).scrollTop(
                            d(document).scrollTop() - b.scrollSpeed
                        );
                    else if (
                        d(window).height() -
                            (a.pageY - d(document).scrollTop()) <
        ...
        serialize: function (a) {
            ...
            d(b).each(function () {
                var e = (
                    d(a.item || this).attr(a.attribute || "id") || ""
        ...
        _createPlaceholder: function (a) {
            ...
            if (!c.placeholder || c.placeholder.constructor == String) {
                ...
                c.placeholder = {
                    element: function () {
                        var f = d(
                            document.createElement(b.currentItem[0].nodeName)
                        )
                            .addClass(
                                e ||
                            ...
                            g.width() ||
                                g.width(
                                    b.currentItem.innerWidth() -
                                        parseInt(
                                            b.currentItem.css("paddingLeft") ||
                                                0,
                                            10
                                        ) -
                                        parseInt(
                                            b.currentItem.css("paddingRight") ||
                                                0,
                                            10
                                        )
                                );
        ...
        _contactContainers: function (a) {
            for (
                var b = null, c = null, e = this.containers.length - 1;
                e >= 0;
                e--
            )
                if (
        ...
        _generatePosition: function (a) {
            ...
            if (this.originalPosition) {
                ...
                if (b.grid) {
                    ...
                    f =
                        this.originalPageX +
                        Math.round((f - this.originalPageX) / b.grid[0]) *
                            b.grid[0];
                    f = this.containment
                        ? !(
    ...
    (function (f, j) {
        ...
        f.extend(f.easing, {
            ...
            easeInOutBounce: function (c, a, b, d, e) {
                ...
                return (
                    f.easing.easeOutBounce(c, a * 2 - e, 0, d, e) * 0.5 +
                    d * 0.5 +
                    b
                );
            },
...
(function (j) {
    j.effects.explode = function (a) {
        return this.queue(function () {
            var c = a.options.pieces
                    ? Math.round(Math.sqrt(a.options.pieces))
                    : 3,
                d = a.options.pieces
                    ? Math.round(Math.sqrt(a.options.pieces))
                    : 3;
...
(function (c) {
    ...
    c.effects.scale = function (b) {
        return this.queue(function () {
            ...
            a.from =
                b.options.from || (g == "show" ? { height: 0, width: 0 } : f);
            h = {
            ...
            if (m == "content" || m == "both") {
                ...
                a.find("*[width]").each(function () {
                    ...
                    if (d.from.y != d.to.y) {
                        ...
                        child.to = c.effects.setTransition(
                            child,
                            f,
                            d.to.y,
                            child.to
        ...
        _clickHandler: function (a, b) {
            ...
            if (!d.disabled)
                if (a.target) {
                    ...
                    b = a[0] === this.active[0];
                    d.active =
                        d.collapsible && b ? false : this.headers.index(a);
                ...
                if (!this.active || this.last())
                    ...
                    var b = this.active.offset().top,
                        ...
                        d = this.element.children("li").filter(function () {
                            var f =
                                e(this).offset().top - b - c + e(this).height();
                            return f < 10 && f > -10;
                        });
    ...
    var g,
        ...
        h = function (b) {
            ...
            if (c)
                e = d
                    ? a(d).find("[name='" + c + "']")
                    : a("[name='" + c + "']", b.ownerDocument).filter(
                          function () {
                              return !this.form;
                          }
                      );
...
(function (d, G) {
    ...
    d.extend(L.prototype, {
        ...
        _doKeyPress: function (a) {
            ...
            if (d.datepicker._get(b, "constrainInput")) {
                ...
                var c = String.fromCharCode(
                    a.charCode == G ? a.keyCode : a.charCode
                );
        ...
        _showDatepicker: function (a) {
            ...
            if (
                !(
                    d.datepicker._isDisabledDatepicker(a) ||
                ...
                var e =
                    ...
                    n = function (p, w, H) {
                        ...
                        for (w = 0; w < p.length; w++)
                            if (
                                b.substr(s, p[w].length).toLowerCase() ==
                                p[w].toLowerCase()
                            ) {
                                s += p[w].length;
                                return w + 1;
                    ...
                    for (
                        ...
                        switch (j[2] || "d") {
                            ...
                            case "M":
                                ...
                                g = Math.min(
                                    g,
                                    d.datepicker._getDaysInMonth(k, l)
                                );
                                break;
                            case "y":
                            case "Y":
        ...
        _generateHTML: function (a) {
            ...
            for (
                var M = this._getDefaultDate(a), I = "", C = 0;
                C < i[0];
                C++
            ) {
                for (var N = "", D = 0; D < i[1]; D++) {
                    var J = this._daylightSavingAdjust(
                            new Date(m, g, a.selectedDay)
                        ),
                        t = " ui-corner-all",
                        x = "";
                    if (l) {
    ...
    d.widget("ui.slider", d.ui.mouse, {
        ...
        _create: function () {
            ...
            if (b.values && b.values.length)
                for (
                    ;
                    d(".ui-slider-handle", this.element).length <
                    b.values.length;
            ...
            this.handles
                ...
                .focus(function () {
                    if (b.disabled) d(this).blur();
                        ...
                        d(".ui-slider .ui-state-focus").removeClass(
                            "ui-state-focus"
                        );
        ...
        _refreshValue: function () {
            ...
            if (this.options.values && this.options.values.length)
                this.handles.each(function (k) {
                    f =
                        ((c.values(k) - c._valueMin()) /
                            (c._valueMax() - c._valueMin())) *
                        100;
                    h[c.orientation === "horizontal" ? "left" : "bottom"] =
                        f + "%";
    ...
    d.widget("ui.tabs", {
        ...
        _tabify: function (a) {
            ...
            if (a) {
                ...
                if (c.selected === p) {
                    ...
                    if (
                        ...
                        c.selected = this.lis.index(
                            this.lis.filter(".ui-tabs-selected")
                        );
                    c.selected = c.selected || (this.lis.length ? 0 : -1);
                } else if (c.selected === null) c.selected = -1;
                c.selected =
                    (c.selected >= 0 && this.anchors[c.selected]) ||
                    c.selected < 0
                        ? c.selected
                        : 0;
                c.disabled = d
            ...
            for (var j; (j = this.lis[a]); a++)
                d(j)[
                    d.inArray(a, c.disabled) != -1 &&
                    !d(j).hasClass("ui-tabs-selected")
                        ? "addClass"
                        : "removeClass"
                ]("ui-state-disabled");
